...
<div id="register" class="auto">
    <h2>欢迎注册成为 私房库会员</h2>
    <form method="post">
        <label>用户名：<input type="text" name="name" autocomplete="off"/><span>*用户名不得为空，并且长度不得超过32个字符</span></label>
        <label>密码：<input type="password" name="pw" autocomplete="off"/><span>*密码不得少于6位</span></label>
        <label>确认密码：<input type="password" name="confirm_pw" autocomplete="off"/><span>*请输入与上面一致</span></label>
        <label>验证码：<input type="text" name="vcode" autocomplete="off"/><span>*请输入下方验证码</span></label>
